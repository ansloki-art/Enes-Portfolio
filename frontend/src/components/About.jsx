...
const stats = [
  ...
  { icon: "⏱", value: "1+ year",     label: "Building solo" },
  { icon: "🚀", value: "3+ shipped",  label: "Real products" },
];
...
const skills = [
  ...
  {
    label: "Tools & Infra",
    items: ["Supabase", "Vercel", "Cloudflare R2", "boto3", "Git & GitHub"],
  },
];
      ...
      <div className="max-w-4xl mx-auto px-6">
        <Reveal>
          ...
          <p className="mt-5 max-w-2xl text-base leading-relaxed text-zinc-500">
            ...
            web apps solo. I handle everything — from database schema to pixel-polished
            frontends — and I ship things that actually work.
          </p>
        </Reveal>
