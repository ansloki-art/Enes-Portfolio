    ...
    <section id="contact" className="py-28 bg-zinc-900">
      <div className="max-w-4xl mx-auto px-6 text-center">
        ...
        <div className="mt-10 flex flex-wrap justify-center gap-3">
          <a
            href="https://wa.me/6282285423278"
            target="_blank"
            rel="noreferrer"
            className="btn-primary inline-flex items-center gap-2 rounded-xl bg-emerald-500 px-6 py-3 text-sm font-semibold text-white hover:bg-emerald-600"
          >
