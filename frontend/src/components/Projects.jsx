      ...
      <div className="max-w-4xl mx-auto px-6">
        ...
        <div className="mt-12 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {projects.map((project, i) => {
            const isLoneOnSm = projects.length % 2 !== 0 && i === projects.length - 1;
            return (
            <Reveal key={project.title} delay={i * 100} direction="up"
              className={isLoneOnSm ? "sm:col-span-2 sm:max-w-md sm:mx-auto sm:w-full lg:col-span-1 lg:max-w-none lg:mx-0" : ""}>
              <div className="card-lift group border border-zinc-200 rounded-2xl overflow-hidden bg-white flex flex-col h-full">
